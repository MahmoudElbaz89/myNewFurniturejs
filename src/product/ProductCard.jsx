...
export function ProductCard({ product }) {
    ...
    return (
        <>
            <div className="relative overflow-hidden rounded-xl bg-white shadow transition-all duration-300 hover:shadow-lg hover:-translate-y-2 group">
                ...
                {showToast && (
                    <div className="absolute bottom-0 right-4 bg-green-600 text-white px-4 py-2 rounded shadow-md text-sm z-50 animate-fade-in-out">
