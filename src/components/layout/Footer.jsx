  ...
  return (
    <footer className="mx-auto bg-[rgb(242,240,237)] w-full overflow-hidden">
      <div className="container mx-auto px-4 py-12 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 justify-items-center lg:justify-items-stretch gap-8 w-full">
          {/* Company Info */}
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              {/* logo */}
              <img src={logo} alt="Furniture" className="h-7 w-auto" />
            ...
            <p className="text-gray-500 text-sm">
              Exquisite design combined with functionalities. Creating beautiful
