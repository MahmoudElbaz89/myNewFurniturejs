  ...
  return (
    <>
      <div className="min-h-screen color pb-16">
        ...
        <div className="container mx-auto max-w-7xl pt-12 lg:pt-20 ">
          <div className="flex flex-col gap-8 lg:flex-row">
            {/* Contact Form */}
            <div className="w-full lg:w-1/2 xl:w-[45%] mx-auto">
            ...
            {/* Contact Information */}
            <div className=" lg:w-1/2 xl:w-[45%] mx-auto">
              <div className=" rounded-xl  p-6 md:p-8 h-full">
                <div className="mb-8">
                  ...
                  <p className="text-gray-600">
                    Visit our showroom to see our furniture collections in
                    person, or reach out to us through any of the following
                    channels.
                  </p>
                </div>
          ...
          <div className=" container max-w-6xl mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600">
                ...
                features our latest collections.
              </p>
            </div>
