      ...
      <div className="py-16 text-center bg-gradient-to-r from-furniture-cream to-furniture-warm">
        <Container maxWidth="lg">
          ...
          <h6 className="max-w-3xl mx-auto text-gray-600 text-center mb-6 ">
            For over two decades, we've been crafting exceptional furniture that
            combines timeless design with modern functionality. Every piece
            tells a story of quality, passion, and attention to detail.
          </h6>
        </Container>
      </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-1/2">
              ...
              <div className="space-y-4 text-gray-600 mb-8">
                <p>
                  What started as a small family workshop has grown into a
                  renowned furniture studio. Our journey began with a simple
                  belief: furniture should be more than just functional—it
                  should inspire.
                </p>
                <p>
                  Today, we continue to honor traditional craftsmanship while
                  embracing innovative design techniques. Each piece is
                  carefully created to enhance your living space and stand the
                  test of time.
                </p>
              </div>
              <Button
        ...
        <Container maxWidth="lg">
          ...
          <div className="grid  grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, index) => (
              <div
                key={index}
                className="h-full bg-white flex flex-col items-center text-center p-6 border border-gray-200 rounded-xl hover:shadow-lg hover:border-furniture-green transition-all duration-300"
              >
        ...
        <Container maxWidth="md">
          <div className="text-center mb-12">
            ...
            <Typography className="opacity-90 mb-8 text-lg">
              Discover our full collection of handcrafted furniture and find the
